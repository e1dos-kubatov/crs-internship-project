...
- `frontend/src/api/client.js` по умолчанию смотрит на `https://crs-internship-project-api.onrender.com/api`.
...
```text
https://crs-internship-project-api.onrender.com
```

Проверка backend:

```text
https://crs-internship-project-api.onrender.com/api/auth/oauth2/status
```
...
```text
VITE_API_URL=https://crs-internship-project-api.onrender.com/api
NODE_VERSION=22
```
...
```text
https://crs-internship-project-api.onrender.com/login/oauth2/code/google
```
