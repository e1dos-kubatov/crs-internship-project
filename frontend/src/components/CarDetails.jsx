          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] border border-white/70 bg-white/85 p-8 shadow-xl backdrop-blur">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  <p className="text-sm font-bold uppercase tracking-[0.25em] text-sky-700">{t('verifiedFleet')}</p>
                ...
                <div className="rounded-3xl bg-slate-950 px-5 py-4 text-right text-white">
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest text-slate-300">{t('perDay')}</p>
                </div>
              </div>
            ...
            <div className="rounded-[2rem] bg-gradient-to-br from-slate-950 via-sky-950 to-orange-900 p-8 text-white shadow-2xl">
              <h3 className="text-3xl font-black">{t('readyToBook')}</h3>
              <p className="mt-3 text-slate-200">{t('backendRentalHint')}</p>
              <button
