    ...
    <div className="min-h-screen bg-transparent">
      <header className="border-b border-white/70 bg-white/80 shadow-sm backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-6 sm:px-6 lg:px-8">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.25em] text-sky-700">Partner dashboard</p>
            <h1 className="mt-2 text-3xl font-black text-slate-950">My account</h1>
          </div>
        ...
        <Routes>
          <Route path="/bookings" element={
            <div className="rounded-[2rem] border border-white/70 bg-white/85 p-6 shadow-xl backdrop-blur">
              <h2 className="mb-6 text-2xl font-black text-slate-950">Backend rentals</h2>
              {loading ? (
                <p className="text-slate-500">Loading rentals...</p>
              ) : bookings.length === 0 ? (
                <p className="text-slate-500">No rentals yet. Pick a car and create your first booking.</p>
              ) : (
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-slate-200">
                    <thead>
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-black uppercase tracking-wider text-slate-500">Car</th>
                        <th className="px-4 py-3 text-left text-xs font-black uppercase tracking-wider text-slate-500">Dates</th>
                        <th className="px-4 py-3 text-left text-xs font-black uppercase tracking-wider text-slate-500">Total</th>
            ...
            <div>
              <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div className="rounded-[2rem] bg-white/85 p-6 shadow-xl backdrop-blur">
                  ...
                  <dt className="text-sm font-bold text-slate-500">Active rentals</dt>
                ...
                <div className="rounded-[2rem] bg-white/85 p-6 shadow-xl backdrop-blur">
                  ...
                  <dt className="text-sm font-bold text-slate-500">Total spend</dt>
              ...
              <div className="rounded-[2rem] border border-white/70 bg-white/85 p-8 shadow-xl backdrop-blur">
                <h3 className="mb-5 text-2xl font-black text-slate-950">Profile</h3>
